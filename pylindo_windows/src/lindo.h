 ...
 **
 **    $Id: lindo.h 3384 2021-04-09 18:05:33Z svn $
 **
 *********************************************************************/
...
typedef struct LSsample   *pLSsample;
typedef struct LSrandGen  *pLSrandGen;
typedef struct LSbio      *pLSbio;
typedef struct LSspvIdx   *pLSspvIdx;
typedef struct LSspv      *pLSspv;
...
/* Version macros */
#define LS_MAJOR_VER_NUMBER                 13
#define LS_MINOR_VER_NUMBER                 0
#define LS_REV_VER_NUMBER                   262
#define LS_VER_NUMBER                       1300
#define LS_BUILD_VER_NUMBER                 4099
...
#define LS_CONETYPE_PEXP                    'E'
#define LS_CONETYPE_PPOW                    'P'

#define LS_VARTYPE_CONT                     'C'
#define LS_VARTYPE_BIN                      'B'
#define LS_VARTYPE_INT                      'I'
#define LS_VARTYPE_SC                       'S'
...
#define LS_BASFILE_MTX                      4

#define LS_INT_TYPE                         4
#define LS_DOUBLE_TYPE                      8

#define LS_MAX_ERROR_MESSAGE_LENGTH         1024

#define LS_DEFAULT                          -1
#define LS_MAX_JOBJECTS                     100

#define LS_PROPERTY_UNKNOWN                 0
#define LS_PROPERTY_CONST                   1
#define LS_PROPERTY_LINEAR                  2
#define LS_PROPERTY_CONVEX                  3
#define LS_PROPERTY_CONCAVE                 4
#define LS_PROPERTY_QUASI_CONVEX            5
#define LS_PROPERTY_QUASI_CONCAVE           6
#define LS_PROPERTY_MAX                     7
#define LS_PROPERTY_MONO_INCREASE           8
#define LS_PROPERTY_MONO_DECREASE           9

/* bitmasks for LScopyModel */
#define LS_RAW_COPY                         0
#define LS_DEEP_COPY                        1
#define LS_TIME_COPY                        2
#define LS_STOC_COPY                        4
#define LS_SNGSTG_COPY                      8

// language identifiers
#define LS_LANG_C                           0
#define LS_LANG_CS                          1
#define LS_LANG_VB                          2
#define LS_LANG_LUA                         3
...
#define LSMIN20                             1200
#define LSMIN30                             1800
#define LSHOUR01                            3600
#define LSHOUR02                            7200
#define LSHOUR03                            10800
#define LSHOUR05                            18000
#define LSHOUR06                            21600
#define LSHOUR08                            28800
#define LSHOUR12                            43200
#define LSDAY                               86400
#define LSWEEK                              604800
#define LSMONTH                             2592000
#define LSQUARTER                           7776000
#define LSYEAR                              31104000

/* Days of week */
#define LSSUNDAY                            0
#define LSMONDAY                            1
#define LSTUESDAY                           2
#define LSWEDNESDAY                         3
#define LSTHURSDAY                          4
#define LSFRIDAY                            5
#define LSSATURDAY                          6

/* bitmask for components */
#define LS_DATA_CORE           1
#define LS_DATA_TIME           2
#define LS_DATA_STOC           4
#define LS_DATA_FILE           8

/* external solvers */
#define LS_XSOLVER_MSKLP       1
#define LS_XSOLVER_GRBLP       2
#define LS_XSOLVER_GRBCL       3
#define LS_XSOLVER_GRBMIP      4
#define LS_XSOLVER_CPXLP       5
#define LS_XSOLVER_CPXMIP      6
#define LS_XSOLVER_OSI         7
#define LS_XSOLVER_CLP         8
#define LS_XSOLVER_MSK         9
#define LS_XSOLVER_COI         10
#define LS_XSOLVER_SOP         11
#define LS_XSOLVER_CBC         12
#define LS_XSOLVER_XPR         13
#define LS_XSOLVER_XLINDO      99


/* ref types */
#define LS_REF_LOCFUN      -1
#define LS_REF_MIPFUN      -2
#define LS_REF_CBFUN       -3
#define LS_REF_FUNCALC     -4
#define LS_REF_GRADCALC    -5
#define LS_REF_HESSCALC    -6
#define LS_REF_LOCDATA     -11
#define LS_REF_MIPDATA     -12
#define LS_REF_CBDATA      -13
#define LS_REF_FDATA       -14
#define LS_REF_GDATA       -15
#define LS_REF_HDATA       -16
#define LS_REF_PREMODEL    -30
 ...
 */
typedef enum LSstocOptDataTypes
{
 ...
 */
typedef enum LSstocOptDistribFun
{
...
typedef enum LSstocOptModifyRule
{
   LS_REPLACE     = 0,
   LS_ADD         = 1,
   LS_SUB         = 2,
 ...
 */
typedef enum LSstocOptDeteqType
{
   LS_DETEQ_FREE         = -1,
   LS_DETEQ_IMPLICIT     = 0,
   LS_DETEQ_EXPLICIT     = 1,
...
typedef enum LSfileFormatSprint
{
...
#define LS_CONIC                            LS_SOCP
#define LS_MICONIC                          LS_MISOCP
...
#define LS_INT_PARAMETER_TYPE               LS_INT_TYPE
#define LS_DOUBLE_PARAMETER_TYPE            LS_DOUBLE_TYPE
/* old parameter names, changed in 8.x */
#define LS_IPARAM_NLP_MSW_MAXREF            LS_IPARAM_NLP_MSW_POPSIZE
#define LS_IPARAM_STOC_DEBUG_LEVEL          LS_IPARAM_STOC_DEBUG_MASK

/* old parameter names changed in 6.x */
#define LS_SPRINT_OUTPUT_FILE_DEFAULT       LS_SPRINT_OUTPUT_FILE_FREE

/* old parameter names changed in 5.x */
#define LS_IPARAM_SPLEX_SCALE               LS_IPARAM_LP_SCALE
#define LS_IPARAM_SPLEX_ITRLMT              LS_IPARAM_LP_ITRLMT
#define LS_IPARAM_MIP_USE_ENUM_HEU          LS_IPARAM_MIP_ENUM_HEUMODE
#define LS_IPARAM_SOLVER_USE_CONCURRENT_OPT LS_IPARAM_SOLVER_CONCURRENT_OPTMODE
#define LS_IPARAM_GOP_USEBNDLIM             LS_IPARAM_GOP_BNDLIM_MODE
...
#define LS_IPARAM_STOC_SAMPLING_METHOD      LS_IPARAM_STOC_VARCONTROL_METHOD
#define LS_DPARAM_GOP_OPTTOL                LS_DPARAM_GOP_RELOPTTOL
/* old operator names */
#define EP_EXT_AND                          EP_VAND
#define EP_EXT_OR                           EP_VOR
#define EP_MULTMULT                         EP_VMULT
#define EP_PUSH_SVAR                        EP_PUSH_SPAR
...
typedef int  (CALLBACKTYPE *MIP_callback_MIPobj_t)(pLSmodel     pModel,
                                                  void        *pvUserData,
                                                  double      *padMIPObjval,
                                                  double      *padMIPBestbound);

typedef int  (CALLBACKTYPE *GOP_callback_t)(pLSmodel pModel,
                                      void        *pvUserData,
                                      double      dObjval,
                                      double      *padPrimal);
...
typedef int  (CALLBACKTYPE *cbStrategy_t)(pLSmodel    pModel,
                                      int         nRunId,
                                      void        *pvUserData);
...
typedef int  (CALLBACKTYPE *Hessdccalc_type)(pLSmodel pmodel,
                                      void           *pvUserData,
                                      int            nRow,
                                      double         *pdX,
                                      double         *pdD,
...
typedef void (LS_CALLTYPE *printEnvLOG_t)(pLSenv        pEnv,
                                      char          *pachStr,
                                      void          *pvPrnData);

typedef void (LS_CALLTYPE *printModelLOG_t)(pLSmodel    pModel,
                                      char          *pachStr,
                                      void          *pvPrnData);
...
typedef int (CALLBACKTYPE *LSfuncExit_t) (void      *pvUserData,
                                      char          *pachFile,
                                      int           nLine,
                                      char          *pachmsg);

typedef int  (CALLBACKTYPE *MIP_Alg_callback_t)(pLSmodel pModel,
                                                void     *pALG_data,
                                                void     *pProbeCliqueGraph,
                                                int      *pnMIPSolStatus);
 ...
 *********************************************************************/
 ...
 pLSenv LS_CALLTYPE LScreateEnv(int     *pnErrorcode,
                             char    *pszPassword);

 pLSmodel LS_CALLTYPE LScreateModel(pLSenv pEnv,
                             int     *pnErrorcode);

 int LS_CALLTYPE LSdeleteEnv(pLSenv *pEnv);


 int LS_CALLTYPE LSdeleteModel(pLSmodel *pModel);


 int LS_CALLTYPE LSloadLicenseString(char *pszFname,
                             char    *pachLicense);

 void LS_CALLTYPE LSgetVersionInfo(char *pachVernum,
                             char    *pachBuildDate);

 int LS_CALLTYPE LScopyParam(pLSmodel sourceModel,
                          pLSmodel targetModel,
                          int      mSolverType);

 int LS_CALLTYPE LSsetXSolverLibrary(pLSenv pEnv,
                             int     mVendorId,
                             char    *szLibrary);

 int LS_CALLTYPE LSgetXSolverLibrary(pLSenv pEnv,
                             int     mVendorId,
                             char    *szLibrary);
/**********************************************************************
 ...
 **********************************************************************/
 ...
 int LS_CALLTYPE LSreadMPSFile(pLSmodel pModel,
                             char    *pszFname,
                             int     nFormat);

 int LS_CALLTYPE LSwriteMPSFile(pLSmodel pModel,
                             char    *pszFname,
                             int     nFormat);

 int LS_CALLTYPE LSreadLINDOFile(pLSmodel pModel,
                             char    *pszFname);

 int LS_CALLTYPE LSwriteLINDOFile(pLSmodel pModel,
                             char    *pszFname);

 int LS_CALLTYPE LSreadLINDOStream(pLSmodel pModel,
                             char    *pszStream,
                             int     nStreamLen);

 int LS_CALLTYPE LSwriteLINGOFile(pLSmodel pModel,
                             char    *pszFname);

 int LS_CALLTYPE LSwriteDualMPSFile(pLSmodel pModel,
                             char    *pszFname,
                             int     nFormat,
                             int     nObjSense);

 int LS_CALLTYPE LSwriteDualLINDOFile(pLSmodel pModel,
                             char    *pszFname,
                             int     nObjSense);

 int LS_CALLTYPE LSwriteSolution(pLSmodel pModel,
                             char    *pszFname);

 int LS_CALLTYPE LSwriteNLSolution(pLSmodel pModel,
                             char    *pszFname);

 int LS_CALLTYPE LSwriteSolutionOfType(pLSmodel  pModel,
                             char    *pszFname,
                             int     nFormat);

 int LS_CALLTYPE LSwriteIIS(pLSmodel  pModel,
                             char    *pszFname);

 int LS_CALLTYPE LSwriteIUS(pLSmodel  pModel,
                             char    *pszFname);

 int LS_CALLTYPE LSreadMPIFile(pLSmodel pModel,
                             char    *pszFname);

 int LS_CALLTYPE LSwriteMPIFile(pLSmodel pModel,
                             char    *pszFname);

 int LS_CALLTYPE LSwriteMPXFile(pLSmodel pModel,
                             char    *pszFname,
                             int mMask);

 int LS_CALLTYPE LSwriteWithSetsAndSC(pLSmodel  pModel,
                             char    *pszFname,
                             int     nFormat);

 int LS_CALLTYPE LSreadBasis(pLSmodel  pModel,
                             char    *pszFname,
                             int     nFormat);

 int LS_CALLTYPE LSwriteBasis(pLSmodel  pModel,
                             char    *pszFname,
                             int     nFormat);

 int LS_CALLTYPE LSwriteVarPriorities(pLSmodel  pModel,
                              char    *pszFname,
                              int     nMode);

 int LS_CALLTYPE LSreadLPFile(pLSmodel pModel,
                             char    *pszFname);

 int LS_CALLTYPE LSreadLPStream(pLSmodel pModel,
                             char    *pszStream,
                             int     nStreamLen);

 int LS_CALLTYPE LSreadSDPAFile(pLSmodel pModel,
                           char    *pszFname);

 int LS_CALLTYPE LSreadCBFFile(pLSmodel pModel,
                           char    *pszFname);

 int LS_CALLTYPE LSreadMPXFile(pLSmodel pModel,
	                         char    *pszFname);

 int LS_CALLTYPE LSreadMPXStream(pLSmodel pModel,
                             char    *pszStream,
                             int     nStreamLen);
 int LS_CALLTYPE LSreadNLFile(pLSmodel pModel,
                             char    *pszFname);
 ...
 **********************************************************************/
 ...
 int LS_CALLTYPE LSgetFileError(pLSmodel pModel,
                             int     *pnLinenum,
                             char    *pachLinetxt);

 int LS_CALLTYPE LSgetErrorRowIndex(pLSmodel  pModel,
                             int     *piRow);

 int LS_CALLTYPE LSgetDataType(pLSenv pEnv,
                             int     nDataMacro);
/**********************************************************************
 * Routines for Setting and Retrieving Parameter Values (14)          *
 **********************************************************************/

 int LS_CALLTYPE LSsetModelParameter(pLSmodel pModel,
                             int     nParameter,
                             void    *pvValue);

 int LS_CALLTYPE LSgetModelParameter(pLSmodel pModel,
                             int     nParameter,
                             void    *pvValue);

 int LS_CALLTYPE LSsetEnvParameter(pLSenv pEnv,
                             int     nParameter,
                             void    *pvValue);

 int LS_CALLTYPE LSgetEnvParameter(pLSenv pEnv,
                             int     nParameter,
                             void    *pvValue);

 int LS_CALLTYPE LSsetModelDouParameter(pLSmodel pModel,
                             int     nParameter,
                             double  dVal);

 int LS_CALLTYPE LSgetModelDouParameter(pLSmodel pModel,
                             int     nParameter,
                             double  *pdVal);

 int LS_CALLTYPE LSsetModelIntParameter(pLSmodel pModel,
                             int     nParameter,
                             int     nVal);

 int LS_CALLTYPE LSgetModelIntParameter(pLSmodel pModel,
                             int     nParameter,
                             int     *pnVal);

 int LS_CALLTYPE LSsetEnvDouParameter(pLSenv pEnv,
                             int     nParameter,
                             double  dVal);

 int LS_CALLTYPE LSgetEnvDouParameter(pLSenv pEnv,
                             int     nParameter,
                             double  *pdVal);

 int LS_CALLTYPE LSsetEnvIntParameter(pLSenv pEnv,
                             int     nParameter,
                             int     nVal);

 int LS_CALLTYPE LSgetEnvIntParameter(pLSenv pEnv,
                             int     nParameter,
                             int     *pnVal);

 int LS_CALLTYPE LSreadModelParameter(pLSmodel pModel,
                             char    *pszFname);

 int LS_CALLTYPE LSreadEnvParameter(pLSenv pEnv,
                             char    *pszFname);

 int LS_CALLTYPE LSwriteModelParameter(pLSmodel pModel,
                             char    *pszFname);

 int LS_CALLTYPE LSwriteEnvParameter(pLSenv pEnv,
                             char    *pszFname);

int LS_CALLTYPE LSwriteParameterAsciiDoc(pLSenv pEnv,
                             char    *pszFileName);

 int LS_CALLTYPE LSgetIntParameterRange(pLSmodel pModel,
                                     int     nParameter,
                                     int     *pnValMIN,
                                     int     *pnValMAX);

 int LS_CALLTYPE LSgetDouParameterRange(pLSmodel pModel,
                                     int     nParameter,
                                     double  *pdValMIN,
                                     double  *pdValMAX);

 int LS_CALLTYPE LSgetParamShortDesc(pLSenv pEnv,
                             int      nParam,
                             char     *pachDescription);

int LS_CALLTYPE LSgetParamLongDesc(pLSenv pEnv,
                             int      nParam,
                             char     *pachDescription);

int LS_CALLTYPE LSgetParamMacroName(pLSenv pEnv,
                             int      nParam,
                             char     *pachParam);

int LS_CALLTYPE LSgetParamMacroID(pLSenv pEnv,
                             char     *szParam,
                             int      *pnParamType,
                             int      *pnParam);

int LS_CALLTYPE LSgetQCEigs(pLSmodel pModel,
                             int      iRow,
                             char     *pachWhich,
                             double   *padEigval,
                             double   **padEigvec,
...
// Matrix operations
int LS_CALLTYPE LSgetEigs(int nDim,
                             char     chUL,
                             double   *padA,
                             double   *padD,
                             double   *padV,
...
int LS_CALLTYPE LSgetEigg(int nDim,
                          char chJOBV,
                          double *padA,
                          double *padWR,
                          double *padWI,
...
int LS_CALLTYPE LSgetMatrixTranspose(int nRows,
                             int      nCols,
                             double   *padA,
                             double   *padAT);

int LS_CALLTYPE LSgetMatrixInverse(int nRows,
                             double   *padA,
                             double   *padAinv,
                             int      *pnInfo);

int LS_CALLTYPE LSgetMatrixInverseSY(int nRows,
                             char     chUpLo,
                             double   *padA,
                             double   *padAinv,
                             int      *pnInfo);

int LS_CALLTYPE LSgetMatrixLUFactor(int nRows,
                             int      nCols,
                             double   *padA,
                             int      *panP,
                             double   *padL,
...
int LS_CALLTYPE LSgetMatrixQRFactor(int nRows,
                             int      nCols,
                             double   *padA,
                             double   *padQ,
                             double   *padR,
...
int LS_CALLTYPE LSgetMatrixDeterminant(int nRows,
                             double   *padA,
                             double   *padDet,
                             int      *pnInfo);

int LS_CALLTYPE LSgetMatrixCholFactor(int nRows,
                             char     chUpLo,
                             double   *padA,
                             double   *padUL,
                             int      *pnInfo);

int LS_CALLTYPE LSgetMatrixSVDFactor(int nRows,
                             int      nCols,
                             double   *padA,
                             double   *padU,
                             double   *padS,
...
int LS_CALLTYPE LSgetMatrixFSolve(char *szuplo,
                             char     *sztrans,
                             char     *szdiag,
                             int      nRows,
                             double   dAlpha,
...
int LS_CALLTYPE LSgetMatrixBSolve(char *szuplo,
                             char     *sztrans,
                             char     *szdiag,
                             int      nRows,
                             double   dAlpha,
...
int LS_CALLTYPE LSgetMatrixSolve(char *szside,
                             char     *szuplo,
                             char     *sztrans,
                             char     *szdiag,
                             int      nRows,
 ...
 int LS_CALLTYPE LSloadLPData(pLSmodel pModel,
                             int     nCons,
                             int     nVars,
                             int     dObjSense,
                             double  dObjConst,
 ...
 int LS_CALLTYPE LSloadQCData(pLSmodel pModel,
                             int     nQCnnz,
                             int     *paiQCrows,
                             int     *paiQCcols1,
                             int     *paiQCcols2,
 ...
 int LS_CALLTYPE LSloadConeData(pLSmodel pModel,
                             int      nCone,
                             char     *pszConeTypes,
                             double   *padConeAlpha,
                             int      *paiConebegcone,
 ...
 int LS_CALLTYPE LSloadPOSDData(pLSmodel pModel,
                               int      nPOSD,
                               int      *paiPOSDdim,
                               int      *paiPOSDbeg,
                               int      *paiPOSDrowndx,
...
int LS_CALLTYPE LSloadALLDIFFData(pLSmodel pModel,
                                  int      nALLDIFF,
                                  int      *paiAlldiffDim,
                                  int      *paiAlldiffL,
                                  int      *paiAlldiffU,
...
int LS_CALLTYPE LSloadSETSData(pLSmodel pModel,
                             int      nSETS,
                             char     *pszSETStype,
                             int      *paiCARDnum,
                             int      *paiSETSbegcol,
 ...
 int LS_CALLTYPE LSloadSemiContData(pLSmodel pModel,
                             int      nSCVars,
                             int      *paiVars,
                             double   *padL,
                             double   *padU);

 int LS_CALLTYPE LSloadVarType(pLSmodel pModel,
                             char    *pszVarTypes);

 int LS_CALLTYPE LSloadNameData(pLSmodel pModel,
                             char    *pszTitle,
                             char    *pszObjName,
                             char    *pszRhsName,
                             char    *pszRngName,
 ...
 int LS_CALLTYPE LSloadNLPData(pLSmodel  pModel,
                             int      *paiNLPcols,
                             int      *panNLPcols,
                             double   *padNLPcoef,
                             int      *paiNLProws,
 ...
 int LS_CALLTYPE LSloadNLPDense(pLSmodel pModel,
                             int      nCons,
                             int      nVars,
                             int      dObjSense,
                             char     *pszConTypes,
 ...
 int LS_CALLTYPE LSloadInstruct(pLSmodel pModel,
                             int    nCons,
                             int    nObjs,
                             int    nVars,
                             int    nNumbers,
 ...
 int LS_CALLTYPE LSaddInstruct(pLSmodel pModel,
                             int    nCons,
                             int    nObjs,
                             int    nVars,
                             int    nNumbers,
 ...
 int LS_CALLTYPE LSloadStringData(pLSmodel pModel,
                             int    nStrings,
                             char   **paszStringData);

 int LS_CALLTYPE LSloadString(pLSmodel pModel,
                             char   *pszString);

 int LS_CALLTYPE LSbuildStringData(pLSmodel pModel);

 int LS_CALLTYPE LSdeleteStringData(pLSmodel pModel);

 int LS_CALLTYPE LSdeleteString(pLSmodel pModel);

 int LS_CALLTYPE LSgetStringValue(pLSmodel pModel,
                             int      iString,
                             double   *pdValue);

 int LS_CALLTYPE LSgetConstraintProperty(pLSmodel pModel,
                             int      ndxCons,
                             int      *pnConptype);

 int LS_CALLTYPE LSsetConstraintProperty(pLSmodel pModel,
                             int      ndxCons,
                             int      nConptype);

 int LS_CALLTYPE LSgetGOPVariablePriority(pLSmodel pModel,
                             int      ndxVar,
                             int     *pnPriority);

 int LS_CALLTYPE LSsetGOPVariablePriority(pLSmodel pModel,
                             int      ndxVar,
                             int      nPriority);

 int LS_CALLTYPE LSloadMultiStartSolution(pLSmodel  pModel,
                             int      nIndex);

 int LS_CALLTYPE LSloadGASolution(pLSmodel  pModel,
                             int      nIndex);

 int LS_CALLTYPE LSaddQCShift(pLSmodel pModel,
                             int      iRow,
                             double   dShift);

 int LS_CALLTYPE LSgetQCShift(pLSmodel pModel,
                             int      iRow,
                             double   *pdShift);

 int LS_CALLTYPE LSresetQCShift(pLSmodel pModel,
                             int      iRow);

 int LS_CALLTYPE LSaddObjPool(pLSmodel  pModel,
                             double   *padC,
                             int      mObjSense,
                             int      mRank,
                             double    dRelOptTol);

 int LS_CALLTYPE LSremObjPool(pLSmodel  pModel,
                              int     nObjIndex);

 int LS_CALLTYPE LSfreeObjPool(pLSmodel  pModel);

 int LS_CALLTYPE LSsetObjPoolParam(pLSmodel  pModel,
                             int      nObjIndex,
                             int      mParam,
                             double   dValue);

 int LS_CALLTYPE LSgetObjPoolParam(pLSmodel  pModel,
                             int      nObjIndex,
                             int      mParam,
                             double   *pdValue);

 int LS_CALLTYPE LSgetObjPoolNumSol(pLSmodel  pModel,
                             int      nObjIndex,
                             int      *pNumSol);

 int LS_CALLTYPE LSsetObjPoolName(pLSmodel  pModel,
                             int      nObjIndex,
                             char     *szObjName);
 ...
 **********************************************************************/
 ...
 int LS_CALLTYPE LSloadBasis(pLSmodel pModel,
                             int     *panCstatus,
                             int     *panRstatus);

 int LS_CALLTYPE LSloadVarPriorities(pLSmodel  pModel,
                             int     *panCprior);

 int LS_CALLTYPE LSreadVarPriorities(pLSmodel  pModel,
                             char    *pszFname);

 int LS_CALLTYPE LSloadVarStartPoint(pLSmodel pModel,
                             double  *padPrimal);

 int LS_CALLTYPE LSloadVarStartPointPartial(pLSmodel pModel,
                             int     nCols,
                             int     *paiCols,
                             double  *padPrimal);

 int LS_CALLTYPE LSloadMIPVarStartPoint(pLSmodel pModel,
                             double  *padPrimal);

 int LS_CALLTYPE LSloadMIPVarStartPointPartial(pLSmodel pModel,
                             int     nCols,
                             int     *paiCols,
                             int     *paiPrimal);

 int LS_CALLTYPE LSreadVarStartPoint(pLSmodel pModel,
                             char    *pszFname);

 int LS_CALLTYPE LSloadPrimalStartPoint(pLSmodel pModel,
                             int     nCols,
                             int     *paiCols,
                             double  *padPrimal);

 int LS_CALLTYPE LSloadBlockStructure(pLSmodel pModel,
                             int      nBlock,
                             int      *panRblock,
                             int      *panCblock,
                             int      nType);

 int LS_CALLTYPE LSloadIISPriorities(pLSmodel pModel,
                             int     *panRprior,
                             int     *panCprior);

 int LS_CALLTYPE LSloadSolutionAt(pLSmodel  pModel,
                             int      nObjIndex,
                             int      nSolIndex);
 ...
 **********************************************************************/
 ...
 int LS_CALLTYPE LSoptimize(pLSmodel pModel,
                             int      nMethod,
                             int      *pnSolStatus);

 int LS_CALLTYPE LSsolveMIP(pLSmodel  pModel,
                             int      *pnMIPSolStatus);

 int LS_CALLTYPE LSsolveGOP(pLSmodel pModel,
                             int      *pnGOPSolStatus);

 int LS_CALLTYPE LSoptimizeQP(pLSmodel pModel,
                             int      *pnQPSolStatus);

 int LS_CALLTYPE LScheckConvexity(pLSmodel pModel);

 int LS_CALLTYPE LSsolveSBD(pLSmodel pModel,
                             int      nStages,
                             int      *panRowStage,
                             int      *panColStage,
                             int      *pnStatus);

 int LS_CALLTYPE LSsolveMipBnp(pLSmodel  pModel,
                             int      nBlock,
                             char     *pszFname,
                             int      *pnStatus);
 ...
 **********************************************************************/
 ...
 int LS_CALLTYPE LSgetInfo(pLSmodel  pModel,
                             int     nQuery,
                             void    *pvResult);

 int LS_CALLTYPE LSgetProfilerInfo(pLSmodel pModel,
                             int     mContext,
                             int     *pnCalls,
                             double  *pdElapsedTime);

 char* LS_CALLTYPE LSgetProfilerContext(pLSmodel pModel,
                             int     mContext);

 /* query continous models */
 int LS_CALLTYPE LSgetPrimalSolution(pLSmodel pModel,
                             double  *padPrimal);

 int LS_CALLTYPE LSgetDualSolution(pLSmodel pModel,
                             double  *padDual);

 int LS_CALLTYPE LSgetReducedCosts(pLSmodel pModel,
                             double  *padRedcosts);

 int LS_CALLTYPE LSgetReducedCostsCone(pLSmodel pModel,
                             double  *padRedcosts);

 int LS_CALLTYPE LSgetSlacks(pLSmodel pModel,
                             double  *padSlacks);

 int LS_CALLTYPE LSgetBasis(pLSmodel pModel,
                             int     *panCstatus,
                             int     *panRstatus);

 int LS_CALLTYPE LSgetSolution(pLSmodel  pModel,
                             int      nWhich,
                             double   *padVal);

 int LS_CALLTYPE LSgetNextBestSol( pLSmodel pModel,
                             int     *pnModStatus);

 /* query integer models */
 int LS_CALLTYPE LSgetMIPPrimalSolution(pLSmodel  pModel,
                             double  *padPrimal);

 int LS_CALLTYPE LSgetMIPDualSolution(pLSmodel pModel,
                             double  *padDual);

 int LS_CALLTYPE LSgetMIPReducedCosts(pLSmodel pModel,
                             double  *padRedcosts);

 int LS_CALLTYPE LSgetMIPSlacks(pLSmodel pModel,
                             double  *padSlacks);

 int LS_CALLTYPE LSgetMIPBasis(pLSmodel pModel,
                             int     *panCstatus,
                             int     *panRstatus);

 int LS_CALLTYPE LSgetNextBestMIPSol( pLSmodel pModel,
                             int     *pnIntModStatus);

 int LS_CALLTYPE LSgetKBestMIPSols(pLSmodel pModel,
                             char    *pszFname,
 ...
 int LS_CALLTYPE LSgetLPData(pLSmodel   pModel,
                             int     *pdObjSense,
                             double  *pdObjConst,
                             double  *padC,
                             double  *padB,
 ...
 int LS_CALLTYPE LSgetQCData(pLSmodel   pModel,
                             int     *paiQCrows,
                             int     *paiQCcols1,
                             int     *paiQCcols2,
                             double  *padQCcoef);

 int LS_CALLTYPE LSgetQCDatai(pLSmodel  pModel,
                             int     iCon,
                             int     *pnQCnnz,
                             int     *paiQCcols1,
                             int     *paiQCcols2,
 ...
 int LS_CALLTYPE LSgetVarType(pLSmodel pModel,
                             char    *pachVarTypes);

 int LS_CALLTYPE LSgetVarStartPoint(pLSmodel  pModel,
                             double  *padPrimal);

int LS_CALLTYPE LSgetVarStartPointPartial(pLSmodel  pModel,
                             int       *pnCols,
                             int       *paiCols,
                             double    *padPrimal);

int LS_CALLTYPE LSgetMIPVarStartPointPartial(pLSmodel  pModel,
                             int       *pnCols,
                             int       *paiCols,
                             int       *paiPrimal);

int LS_CALLTYPE LSgetMIPVarStartPoint(pLSmodel  pModel,
                             double    *padPrimal);


int LS_CALLTYPE LSgetSETSData(pLSmodel pModel,
                             int     *piNsets,
                             int     *piNtnz,
                             char    *pachSETtype,
                             int     *paiCardnum,
...
int LS_CALLTYPE LSgetSETSDatai(pLSmodel pModel,
                             int      iSet,
                             char     *pachSETType,
                             int      *piCardnum,
                             int      *piNnz,
...
int LS_CALLTYPE LSsetSETSStatei(pLSmodel pModel,
                             int      iSet,
                             int      mState);

int LS_CALLTYPE LSgetSemiContData(pLSmodel  pModel,
                             int      *piNvars,
                             int      *paiVarndx,
                             double   *padL,
                             double   *padU);

int LS_CALLTYPE LSgetALLDIFFData(pLSmodel  pModel,
                               int       *pinALLDIFF,
                               int       *paiAlldiffDim,
                               int       *paiAlldiffL,
                               int       *paiAlldiffU,
...
int LS_CALLTYPE LSgetALLDIFFDatai(pLSmodel  pModel,
                                int       iALLDIFF,
                                int       *piAlldiffDim,
                                int       *piAlldiffL,
                                int       *piAlldiffU,
...
int LS_CALLTYPE LSgetPOSDData(pLSmodel  pModel,
                            int       *pinPOSD,
                            int       *paiPOSDdim,
                            int       *paiPOSDnnz,
                            int       *paiPOSDbeg,
...
int LS_CALLTYPE LSgetPOSDDatai(pLSmodel  pModel,
                            int       iPOSD,
                            int       *piPOSDdim,
                            int       *piPOSDnnz,
                            int       *paiPOSDrowndx,
 ...
 int LS_CALLTYPE LSgetNameData(pLSmodel pModel,
                             char    *pachTitle,
                             char    *pachObjName,
                             char    *pachRhsName,
                             char    *pachRngName,
 ...
 int LS_CALLTYPE LSgetLPVariableDataj(pLSmodel  pModel,
                             int     iVar,
                             char    *pachVartype,
                             double  *pdC,
                             double  *pdL,
 ...
 int LS_CALLTYPE LSgetVariableNamej(pLSmodel pModel,
                             int     iVar,
                             char    *pachVarName);

 int LS_CALLTYPE LSgetVariableIndex(pLSmodel pModel,
                             char    *pszVarName,
                             int     *piVar);

 int LS_CALLTYPE LSgetConstraintNamei(pLSmodel pModel,
                             int     iCon,
                             char    *pachConName);

 int LS_CALLTYPE LSgetConstraintIndex(pLSmodel pModel,
                             char    *pszConName,
                             int     *piCon );

 int LS_CALLTYPE LSgetConstraintDatai(pLSmodel  pModel,
                             int     iCon,
                             char    *pachConType,
                             char    *pachIsNlp,
                             double  *pdB);

 int LS_CALLTYPE LSgetLPConstraintDatai(pLSmodel pModel,
                             int     iCon,
                             char    *pachConType,
                             double  *pdB,
                             int     *pnNnz,
 ...
 int LS_CALLTYPE LSgetConeNamei(pLSmodel pModel,
                             int     iCone,
                             char    *pachConeName);

 int LS_CALLTYPE LSgetConeIndex(pLSmodel pModel,
                             char    *pszConeName,
                             int     *piCone );

 int LS_CALLTYPE LSgetConeDatai(pLSmodel  pModel,
                             int      iCone,
                             char     *pachConeType,
                             double   *pdConeAlpha,
                             int      *piNnz,
 ...
 int LS_CALLTYPE LSgetNLPData(pLSmodel  pModel,
                            int      *paiNLPcols,
                            int      *panNLPcols,
                            double   *padNLPcoef,
                            int      *paiNLProws,
 ...
 int LS_CALLTYPE LSgetNLPConstraintDatai(pLSmodel  pModel,
                             int     iCon,
                             int     *pnNnz,
                             int     *paiNLPcols,
                             double  *padNLPcoef);

 int LS_CALLTYPE LSgetNLPVariableDataj(pLSmodel  pModel,
                             int     iVar,
                             int     *pnNnz,
                             int     *panNLProws,
                             double  *padNLPcoef);

 int LS_CALLTYPE LSgetNLPObjectiveData(pLSmodel  pModel,
                             int     *pnNLPobjnnz,
                             int     *paiNLPobj,
                             double  *padNLPobj);

 int LS_CALLTYPE LSgetDualModel(pLSmodel pModel,
                             pLSmodel pDualModel);

 int LS_CALLTYPE LSgetInstruct(pLSmodel  pModel,
                            int      *pnObjSense,
                            char     *pachConType,
                            char     *pachVarType,
                            int      *panCode,
...
int LS_CALLTYPE LScalinfeasMIPsolution(pLSmodel pModel,
                            double   *pdIntPfeas,
                            double   *pbConsPfeas,
                            double   *padPrimalMipsol);

int LS_CALLTYPE LSgetRoundMIPsolution(pLSmodel pModel,
                            double   *padPrimal,
...
int LS_CALLTYPE LSgetDuplicateColumns(pLSmodel pModel,
                            int     nCheckVals,
                            int     *pnSets,
                            int     *paiSetsBeg,
                            int     *paiCols);

int LS_CALLTYPE LSgetRangeData(pLSmodel  pModel,
                            double   *padR);


int LS_CALLTYPE LSgetJac(pLSmodel pModel,
                         int *pnJnonzeros,
                         int *pnJobjnnz,
                         int *paiJrows,
                         int *paiJcols,
...
int LS_CALLTYPE LSgetHess(pLSmodel pModel,
                          int *pnHnonzeros,
                          int *paiHrows,
                          int *paiHcol1,
                          int *paiHcol2,
 ...
 **********************************************************************/
 ...
 int LS_CALLTYPE LSaddConstraints(pLSmodel pModel,
                             int     nNumaddcons,
                             char    *pszConTypes,
                             char    **paszConNames,
                             int     *paiArows,
 ...
 int LS_CALLTYPE LSaddVariables(pLSmodel pModel,
                             int     nNumaddvars,
                             char    *pszVarTypes,
                             char    **paszVarNames,
                             int     *paiAcols,
 ...
 int LS_CALLTYPE LSaddCones(pLSmodel    pModel,
                             int      nCone,
                             char     *pszConeTypes,
                             double   *padConeAlpha,
                             char     **paszConenames,
...
int LS_CALLTYPE LSaddSETS(pLSmodel    pModel,
                             int      nSETS,
                             char     *pszSETStype,
                             int      *paiCARDnum,
                             int      *paiSETSbegcol,
...
int LS_CALLTYPE LSaddQCterms(pLSmodel  pModel,
                           int       nQCnonzeros,
                           int       *paiQCconndx,
                           int       *paiQCvarndx1,
                           int       *paiQCvarndx2,
 ...
 int LS_CALLTYPE LSdeleteConstraints(pLSmodel pModel,
                             int      nCons,
                             int      *paiCons);

 int LS_CALLTYPE LSdeleteCones(pLSmodel  pModel,
                             int      nCones,
                             int      *paiCones);

int LS_CALLTYPE LSdeleteSETS(pLSmodel    pModel,
                             int      nSETS,
                             int      *paiSETS);

int LS_CALLTYPE LSdeleteSemiContVars(pLSmodel pModel,
                             int      nSCVars,
                             int      *paiSCVars);

 int LS_CALLTYPE LSdeleteVariables(pLSmodel pModel,
                             int      nVars,
                             int      *paiVars);

 int LS_CALLTYPE LSdeleteQCterms(pLSmodel pModel,
                             int      nCons,
                             int      *paiCons);

int LS_CALLTYPE LSdeleteAj(pLSmodel  pModel,
                             int      iVar1,
                             int      nRows,
                             int      *paiRows);

 int LS_CALLTYPE LSmodifyLowerBounds(pLSmodel pModel,
                             int      nVars,
                             int      *paiVars,
                             double   *padL);

 int LS_CALLTYPE LSmodifyUpperBounds(pLSmodel pModel,
                             int     nVars,
                             int     *paiVars,
                             double  *padU);

 int LS_CALLTYPE LSmodifyRHS(pLSmodel pModel,
                             int     nCons,
                             int     *paiCons,
                             double  *padB);

 int LS_CALLTYPE LSmodifyObjective(pLSmodel pModel,
                             int     nVars,
                             int     *paiVars,
                             double  *padC);

 int LS_CALLTYPE LSmodifyObjConstant(pLSmodel  pModel,
                             double  dObjConst);


int LS_CALLTYPE LSmodifyAj(pLSmodel  pModel,
                             int     iVar1,
                             int     nRows,
                             int     *paiRows,
                             double  *padAj);

 int LS_CALLTYPE LSmodifyCone(pLSmodel pModel,
                             char   cConeType,
                             int    iConeNum,
                             int    iConeNnz,
                             int    *paiConeCols,
 ...
 int LS_CALLTYPE LSmodifySET(pLSmodel   pModel,
                             char    cSETtype,
                             int     iSETnum,
                             int     iSETnnz,
                             int     *paiSETcols);

 int LS_CALLTYPE LSmodifySemiContVars(pLSmodel pModel,
                             int      nSCVars,
                             int      *paiSCVars,
                             double   *padL,
                             double   *padU);

 int LS_CALLTYPE LSmodifyConstraintType(pLSmodel pModel,
                             int     nCons,
                             int     *paiCons,
                             char    *pszConTypes);

 int LS_CALLTYPE LSmodifyVariableType(pLSmodel pModel,
                             int     nVars,
                             int     *paiVars,
                             char    *pszVarTypes);


int LS_CALLTYPE LSaddNLPAj(pLSmodel pModel,
                             int      iVar1,
                             int      nRows,
                             int      *paiRows,
                             double   *padAj);

int LS_CALLTYPE LSaddNLPobj(pLSmodel pModel,
                            int       nCols,
                            int       *paiCols,
                            double    *padColj);

int LS_CALLTYPE LSdeleteNLPobj(pLSmodel pModel,
                            int      nCols,
                            int      *paiCols);
 ...
 *********************************************************************/
 ...
 int LS_CALLTYPE LSgetConstraintRanges(pLSmodel  pModel,
                             double  *padDec,
                             double  *padInc);

 int LS_CALLTYPE LSgetObjectiveRanges(pLSmodel  pModel,
                             double  *padDec,
                             double  *padInc);

 int LS_CALLTYPE LSgetBoundRanges(pLSmodel  pModel,
                             double  *padDec,
                             double  *padInc);

 int LS_CALLTYPE LSgetBestBounds(pLSmodel  pModel,
                             double  *padBestL,
                             double  *padBestU);

 int LS_CALLTYPE LSfindIIS(pLSmodel     pModel,
                             int     nLevel);

 int LS_CALLTYPE LSfindIUS(pLSmodel     pModel,
                             int     nLevel);

 int LS_CALLTYPE LSfindBlockStructure(pLSmodel pModel,
                             int     nBlock,
                             int     nType);

int LS_CALLTYPE LSdisplayBlockStructure(pLSmodel pModel,
                             int     *pnBlock,
                             int     *panNewColIdx,
                             int     *panNewRowIdx,
                             int     *panNewColPos,
 ...
 int LS_CALLTYPE LSgetIIS(pLSmodel  pModel,
                             int     *pnSuf_r,
                             int     *pnIIS_r,
                             int     *paiCons,
                             int     *pnSuf_c,
 ...
 int LS_CALLTYPE LSgetIISInts(pLSmodel  pModel,
                             int     *pnSuf_xnt,
                             int     *pnIIS_xnt,
                             int     *paiVars);

 int LS_CALLTYPE LSgetIISSETs(pLSmodel  pModel,
                             int     *pnSuf_set,
                             int     *pnIIS_set,
                             int     *paiSets);

 int LS_CALLTYPE LSgetIUS(pLSmodel  pModel,
                             int     *pnSuf,
                             int     *pnIUS,
                             int     *paiVars);

 int LS_CALLTYPE LSgetBlockStructure(pLSmodel pModel,
                             int     *pnBlock,
                             int     *panRblock,
                             int     *panCblock,
                             int     *pnType);

void *LS_CALLTYPE LSfindSymmetry(pLSmodel pModel,
                                 int      *pnerrorcode);

int LS_CALLTYPE LSdeleteSymmetry(void **pSymInfo);

int LS_CALLTYPE LSgetOrbitInfo(void *pSymInfo,
                               int  *pnNumGenerators,
                               int  *pnNumOfOrbits,
                               int  *panOrbitBeg,
                               int  *panOrbits);
 ...
 **********************************************************************/
 ...
 int LS_CALLTYPE LSdoBTRAN(pLSmodel pModel,
                             int     *pcYnz,
                             int     *paiY,
                             double  *padY,
                             int     *pcXnz,
 ...
 int LS_CALLTYPE LSdoFTRAN(pLSmodel pModel,
                             int     *pcYnz,
                             int     *paiY,
                             double  *padY,
                             int     *pcXnz,
 ...
 int LS_CALLTYPE LScalcObjFunc(pLSmodel pModel,
                             double  *padPrimal,
                             double  *pdObjval);

 int LS_CALLTYPE LScalcConFunc(pLSmodel pModel,
                             int      iRow,
                             double   *padPrimal,
                             double   *padSlacks);

 int LS_CALLTYPE LScalcObjGrad(pLSmodel pModel,
                             double  *padPrimal,
                             int     nParList,
                             int     *paiParList,
                             double  *padParGrad);

 int LS_CALLTYPE LScalcConGrad(pLSmodel pModel,
                             int     irow,
                             double  *padPrimal,
                             int     nParList,
                             int     *paiParList,
 ...
 int  LS_CALLTYPE LScheckQterms(pLSmodel   pModel,
                             int        nCons,
                             int        *paiCons,
                             int        *paiType);

 int  LS_CALLTYPE LSrepairQterms(pLSmodel   pModel,
                             int        nCons,
                             int        *paiCons,
                             int        *paiType);

 int LS_CALLTYPE LScomputeFunction(int    inst,
                             double   *pdInput,
                             double   *pdOutput);

 int LS_CALLTYPE LSfindLtf(pLSmodel pModel,
                             int      *panNewColIdx,
                             int      *panNewRowIdx,
                             int      *panNewColPos,
                             int      *panNewRowPos);

 int LS_CALLTYPE LSapplyLtf(pLSmodel  pModel,
                            int       *panNewColIdx,
                            int       *panNewRowIdx,
                            int       *panNewColPos,
                            int       *panNewRowPos,
 ...
 **********************************************************************/
 ...
 int LS_CALLTYPE LSsetCallback(pLSmodel pModel,
                           cbFunc_t  pfCallback,
                             void    *pvCbData);


 int LS_CALLTYPE LSsetMIPCallback(pLSmodel pModel,
                     MIP_callback_t  pfMIPCallback,
                             void    *pvCbData);

 int LS_CALLTYPE LSsetMIPCCStrategy(pLSmodel pModel,
                              cbStrategy_t   pfStrategy,
                              int            nRunId,
                              char           *szParamFile,
                              void           *pvCbData);

int LS_CALLTYPE LSsetMIPCallbackInsMIPSol(pLSmodel pModel,
                              MIP_callback_t pfMIPCallback,
                              void           *pvCbData);


int LS_CALLTYPE LSsetMIPCallbackInsMIPObj(pLSmodel pModel,
                              MIP_callback_MIPobj_t  pfMIPCallback,
                              void           *pvCbData);


 int LS_CALLTYPE LSgetCallbackInfo(pLSmodel pModel,
                              int     nLocation,
                              int     nQuery,
                              void    *pvValue);

 int LS_CALLTYPE LSgetMIPCallbackInfo(pLSmodel pModel,
                              int     nQuery,
                              void    *pvValue);

 int LS_CALLTYPE LSgetProgressInfo(pLSmodel pModel,
                              int     nLocation,
                              int     nQuery,
                              void    *pvValue);

 /* function evaluation routines for NLP solvers */
 int LS_CALLTYPE LSsetGradcalc(pLSmodel        pModel,
                              Gradcalc_type pfGrad_func,
                              void          *pvUserData,
                              int           nLenUseGrad,
                              int           *pnUseGrad);

 int LS_CALLTYPE LSsetFuncalc(pLSmodel        pModel,
                              Funcalc_type pfFunc,
                              void         *pvFData);


 int LS_CALLTYPE LSsetEnvLogfunc(pLSenv pEnv,
                              printEnvLOG_t  pfLocFunc,
                              void    *pvPrData);


 int LS_CALLTYPE LSsetModelLogfunc(pLSmodel  pModel,
                              printLOG_t  pfLocFunc,
                              void    *pvPrData);

 int LS_CALLTYPE LSsetUsercalc(pLSmodel      pModel,
                              user_callback_t pfUser_func,
                              void          *pvUserData);

int LS_CALLTYPE LSsetEnvExitFunc(pLSenv        pEnv,
                              LSfuncExit_t  pfExitFunc,
                              void          *pvUserData);

int LS_CALLTYPE LSsetGOPCallback(pLSmodel       pModel,
                              GOP_callback_t pfGOP_caller,
                              void           *pvPrData);
/**********************************************************************
 *  Memory Related Routines (7)                                       *
 **********************************************************************/

 void LS_CALLTYPE LSfreeSolverMemory(pLSmodel pModel);

 void LS_CALLTYPE LSfreeHashMemory(pLSmodel pModel);

 void LS_CALLTYPE LSfreeSolutionMemory(pLSmodel pModel);

 void LS_CALLTYPE LSfreeMIPSolutionMemory(pLSmodel pModel);

 void LS_CALLTYPE LSfreeGOPSolutionMemory(pLSmodel pModel);

int LS_CALLTYPE LSsetProbAllocSizes(pLSmodel pModel,
                                 int      n_vars_alloc,
                                 int      n_cons_alloc,
                                 int      n_QC_alloc,
                                 int      n_Annz_alloc,
...
int LS_CALLTYPE LSsetProbNameAllocSizes(pLSmodel pModel,
                                     int      n_varname_alloc,
                                     int      n_rowname_alloc);

int LS_CALLTYPE LSaddEmptySpacesAcolumns(pLSmodel pModel,
                                      int      *paiColnnz);

int LS_CALLTYPE LSaddEmptySpacesNLPAcolumns(pLSmodel pModel,
                                         int      *paiColnnz);

/**********************************************************************
 * new  callback functions from version 5.+  external solver          *
 **********************************************************************/

typedef  int (CALLBACKTYPE *LSdeleteEnv_solver_callback_t)(void **pEnv);

typedef void * (CALLBACKTYPE *LScreateModel_solver_callback_t)(pLSmodel        pModel,
                                                               void           *pvSolverEnv,
                                                               int            *errorcode);

typedef int (CALLBACKTYPE *LSdeleteModel_solver_callback_t)(void  **pvSolverTask);


typedef int (CALLBACKTYPE *LSloadLPData_solver_callback_t)(pLSmodel pModel,
                                                           void     *pvSolverTask,
                                                           int      n_cons,
                                                           int      n_vars,
                                                           int      objsense,
...
typedef int  (CALLBACKTYPE *LSloadVarType_solver_callback_t)(pLSmodel  pModel,
                                                                   void     *pvSolverTask,
                                                                   char     *pszVarTypes);

typedef int  (CALLBACKTYPE *LSmodifyLowerBounds_solver_callback_t)(pLSmodel  pModel,
                                                                   void     *pvSolverTask,
                                                                   int      nVars,
                                                                   int      *paiVars,
                                                                   double   *padL);

typedef int  (CALLBACKTYPE *LSmodifyUpperBounds_solver_callback_t)(pLSmodel  pModel,
                                                                   void     *pvSolverTask,
                                                                   int      nVars,
                                                                   int      *paiVars,
                                                                   double   *padU);

typedef int  (CALLBACKTYPE *LSmodifyRHS_solver_callback_t)(pLSmodel  pModel,
                                                           void     *pvSolverTask,
                                                           int       nCons,
                                                           int      *paiCons,
                                                           double   *padB);

typedef int (CALLBACKTYPE *LSmodifyAj_solver_callback_t)(pLSmodel  pModel,
                                                         void     *pvSolverTask,
                                                         int       j,
                                                         int       n_rows,
                                                         int       *rowndx,
...
typedef int (CALLBACKTYPE *LSdeleteAj_solver_callback_t)(pLSmodel  pModel,
                                                         void     *pvSolverTask,
                                                         int       j,
                                                         int       n_rows,
                                                         int       *rowndx);
...
typedef int (CALLBACKTYPE *LSmodifyObjective_solver_callback_t)(pLSmodel  pModel,
                                                                void     *pvSolverTask,
                                                                int       n_objs,
                                                                int       *objndx,
                                                                double    *objval);

typedef int (CALLBACKTYPE *LSmodifyObjConstant_solver_callback_t)(pLSmodel  pModel,
                                                                  void     *pvSolverTask,
                                                                  double    objval);


typedef int (CALLBACKTYPE *LSmodifyConstraintType_solver_callback_t)(pLSmodel  pModel,
                                                                     void     *pvSolverTask,
                                                                     int      nCons,
                                                                     int      *paiCons,
                                                                     char     *pszConTypes);

typedef int (CALLBACKTYPE *LSaddConstraints_solver_callback_t)(pLSmodel  pModel,
                                                               void     *pvSolverTask,
                                                               int      n_addcons,
                                                               char     *con_type,
                                                               char     **paszNames,
...
typedef int (CALLBACKTYPE *LSaddVariables_solver_callback_t)(pLSmodel  pModel,
                                                             void     *pvSolverTask,
                                                             int      n_addvars,
                                                             char     *pszVarTypes,
                                                             char     **paszNames,
...
typedef int (CALLBACKTYPE *LSdeleteConstraints_solver_callback_t)(pLSmodel  pModel,
                                                                  void     *pvSolverTask,
                                                                  int      n_cons,
                                                                  int      *conndx);

typedef int  (CALLBACKTYPE *LSdeleteVariables_solver_callback_t)(pLSmodel pModel,
                                                                 void     *pvSolverTask,
                                                                 int      n_vars,
                                                                 int      *varndx);

typedef int (CALLBACKTYPE *LSloadBasis_solver_callback_t)(pLSmodel  pModel,
                                                          void     *pvSolverTask,
                                                          int     *panCstatus,
                                                          int     *panRstatus);


typedef int (CALLBACKTYPE *LSsetModelIntParameter_solver_callback_t)(pLSmodel  pModel,
                                                                     void     *pvSolverTask,
                                                                     int      nParameter,
                                                                     int     nVal);

typedef int (CALLBACKTYPE *LSsetModelDouParameter_solver_callback_t)(pLSmodel  pModel,
                                                                     void     *pvSolverTask,
                                                                     int      nParameter,
                                                                     double   dVal);

typedef int (CALLBACKTYPE *LSgetInfo_solver_callback_t)(pLSmodel        pModel,
                                                        void           *pvSolverTask,
                                                        int             query,
                                                        void           *result);

typedef int (CALLBACKTYPE *LSsetProbAllocSizes_solver_callback_t)(pLSmodel pModel,
                                                                  void     *pvSolverTask,
                                                                  int      n_vars_alloc,
                                                                  int      n_cons_alloc,
                                                                  int      n_QC_alloc,
...
typedef int (CALLBACKTYPE *LSaddEmptySpacesAcolumns_solver_callback_t)(pLSmodel  pModel,
                                                                       void     *pvSolverTask,
                                                                       int      *colnnz);

typedef  int (CALLBACKTYPE  *LSsetEnvExitFunc_solver_callback_t)(pLSenv                pEnv,
                                                                 void                 *pvSolverEnv,
                                                                 LSfuncExit_t          pfExitFunc,
                                                                 void                 *pvUserData);

typedef  int (CALLBACKTYPE *LSsetCallback_solver_callback_t)(pLSmodel  pModel,
                                                             void     *pvSolverTask,
                                                             int  (CALLBACKTYPE *cbFunc)(pLSmodel pModel, int, void *),
                                                             void    *cbData);

typedef void (CALLBACKTYPE *LSsetLOGfunc_t)(pLSmodel        pModel,
                                            void           *pvSolverTask,
                                            void (CALLBACKTYPE *LOGfunc)(void *LOGdata,const char *str),
                                            void           *LOGdata);



typedef int (CALLBACKTYPE *LSoptimize_solver_callback_t)(pLSmodel  pModel,
                                                         void     *pvSolverTask,
                                                         int      nMethod,
                                                         int      *pnSolStatus);


typedef int (CALLBACKTYPE *LSsolveMIP_solver_callback_t)(pLSmodel  pModel,
                                                         void     *pvSolverTask,
                                                         int      *pnSolStatus);

typedef int (CALLBACKTYPE *LSdoBTRAN_solver_callback_t)(pLSmodel         pModel,
                                                        void            *pvSolverTask,
                                                        int             *bnz,
                                                        int             *bind,
                                                        double          *bcoef,
...
typedef int (CALLBACKTYPE *LSdoDenseBTRAN_solver_callback_t)(pLSmodel        pModel,
                                                             void           *pvSolverTask,
                                                             double         *b,
                                                             double         *x);

typedef int (CALLBACKTYPE *LSdoFTRAN_solver_callback_t)(pLSmodel        pModel,
                                                        void           *pvSolverTask,
                                                        int            *bnz,
                                                        int            *bind,
                                                        double         *bcoef,
...
typedef int  (CALLBACKTYPE *LSdoDenseFTRAN_solver_callback_t)(pLSmodel        pModel,
                                                              void           *pvSolverTask,
                                                              double         *b,
                                                              double         *x);

typedef int (CALLBACKTYPE *LSgetSolution_solver_callback_t)(pLSmodel  pModel,
                                                            void     *pvSolverTask,
                                                            int      nWhich,
                                                            int      *pnProbStatus,
                                                            int      *pnSolStatus,
...
typedef int (CALLBACKTYPE *LSloadMIPVarStartPoint_solver_callback_t)(pLSmodel  pModel,
                                                                  void     *pvSolverTask,
                                                                  double      *primal);

typedef int (LS_CALLTYPE *LSlogmod_t)(pLSmodel model, int nflag, const char *fmt, ...);
typedef int (LS_CALLTYPE *LSlogenv_t)(pLSenv env, int nflag, const char *fmt, ...);

/* Distribution function delegates */
typedef int (LS_CALLTYPE *UserPdf_t) (pLSsample pSample,
                                   int       nFuncType,
                                   double    *padInput,
                                   int       nInput,
                                   double    *pdOutput,
...
int LS_CALLTYPE LSinstalExternalSolver(pLSenv                                     pEnv,
                                    int                                        mVendorId,
                                    void                                       *pvSolverEnv,
                                    LSdeleteEnv_solver_callback_t              deleteEnv,
                                    LScreateModel_solver_callback_t            createModel,
                                    LSdeleteModel_solver_callback_t            deleteModel,
                                    LSloadLPData_solver_callback_t             loadLPData,
                                    LSmodifyLowerBounds_solver_callback_t      modifyLowerBounds,
                                    LSmodifyUpperBounds_solver_callback_t      modifyUpperBounds,
                                    LSmodifyRHS_solver_callback_t              modifyRHS,
                                    LSmodifyAj_solver_callback_t               modifyAj,
                                    LSdeleteAj_solver_callback_t               deleteAj,
                                    LSmodifyObjective_solver_callback_t        modifyObjective,
                                    LSmodifyObjConstant_solver_callback_t      modifyObjConstant,
                                    LSmodifyConstraintType_solver_callback_t   modifyConstraintType,
                                    LSaddConstraints_solver_callback_t         addConstraints,
                                    LSaddVariables_solver_callback_t           addVariables,
                                    LSdeleteConstraints_solver_callback_t      deleteConstraints,
                                    LSdeleteVariables_solver_callback_t        deleteVariables,
                                    LSloadBasis_solver_callback_t              loadBasis,
                                    LSsetModelIntParameter_solver_callback_t   setModelIntParameter,
                                    LSsetModelDouParameter_solver_callback_t   setModelDouParameter,
                                    LSoptimize_solver_callback_t               optimize,
                                    LSgetInfo_solver_callback_t                getInfo,
                                    LSgetSolution_solver_callback_t            getSolution,
                                    LSdoBTRAN_solver_callback_t                doBTRAN,
                                    LSdoDenseBTRAN_solver_callback_t           doDenseBTRAN,
                                    LSdoFTRAN_solver_callback_t                doFTRAN,
                                    LSdoDenseFTRAN_solver_callback_t           doDenseFTRAN,
                                    LSsetProbAllocSizes_solver_callback_t      setProbAllocSizes,
                                    LSaddEmptySpacesAcolumns_solver_callback_t addEmptySpacesAcolnums,
                                    LSsetEnvExitFunc_solver_callback_t         setExitFunc,
                                    LSsetCallback_solver_callback_t            setCallback,
                                    LSsetLOGfunc_t                             setLOGfunc,
                                    LSsolveMIP_solver_callback_t               solveMIP,
                                    LSloadVarType_solver_callback_t            loadVarType);


int LS_CALLTYPE LSdeleteExternalSolver(pLSenv                                     pEnv);
 ...
 *********************************************************************/
/* basic I/O routines */
int LS_CALLTYPE LSwriteDeteqMPSFile(pLSmodel pModel,
                             char     *pszFilename,
                             int      nFormat,
                             int      iType);

int LS_CALLTYPE LSwriteDeteqLINDOFile(pLSmodel pModel,
                             char     *pszFilename,
                             int      iType);


int LS_CALLTYPE LSwriteSMPSFile(pLSmodel pModel,
                             char     *pszCorefile,
                             char     *pszTimefile,
                             char     *pszStocfile,
                             int      nCoretype);

int LS_CALLTYPE LSreadSMPSFile(pLSmodel pModel,
                             char     *pszCorefile,
                             char     *pszTimefile,
                             char     *pszStocfile,
                             int      nCoretype);

int LS_CALLTYPE LSwriteSMPIFile(pLSmodel pModel,
                             char     *pszCorefile,
                             char     *pszTimefile,
                             char     *pszStocfile);

int LS_CALLTYPE LSreadSMPIFile(pLSmodel pModel,
                             char     *pszCorefile,
                             char     *pszTimefile,
                             char     *pszStocfile);


int LS_CALLTYPE LSwriteScenarioSolutionFile(pLSmodel pModel,
                             int      jScenario,
                             char     *pszFname);

int LS_CALLTYPE LSwriteNodeSolutionFile(pLSmodel pModel,
                             int      jScenario,
                             int      iStage,
                             char     *pszFname);

int LS_CALLTYPE LSwriteScenarioMPIFile(pLSmodel   pModel,
                             int      jScenario,
                             char     *pszFname);

int LS_CALLTYPE LSwriteScenarioMPSFile(pLSmodel   pModel,
                             int      jScenario,
                             char     *pszFname,
                             int      nFormat);

int LS_CALLTYPE LSwriteScenarioLINDOFile(pLSmodel   pModel,
                             int      jScenario,
                             char     *pszFname);

/* parameter routines */
int LS_CALLTYPE LSsetModelStocDouParameter(pLSmodel pModel,
                             int      iPar,
                             double   dVal);

int LS_CALLTYPE LSgetModelStocDouParameter(pLSmodel pModel,
                             int      iPar,
                             double   *pdVal);

int LS_CALLTYPE LSsetModelStocIntParameter(pLSmodel pModel,
                             int      iPar,
                             int      iVal);

int LS_CALLTYPE LSgetModelStocIntParameter(pLSmodel pModel,
                             int      iPar,
                             int      *piVal);


/* general query routines */
int LS_CALLTYPE LSgetScenarioIndex(pLSmodel pModel,
                             char     *pszName,
                             int      *pnIndex );


int LS_CALLTYPE LSgetStageIndex(pLSmodel pModel,
                             char     *pszName,
                             int      *pnIndex );

int LS_CALLTYPE LSgetStocParIndex(pLSmodel pModel,
                             char     *pszName,
                             int      *pnIndex );

int LS_CALLTYPE LSgetStocParName(pLSmodel pModel,
                             int      nIndex,
                             char     *pachName);

int LS_CALLTYPE LSgetScenarioName(pLSmodel pModel,
                             int      nIndex,
                             char     *pachName);

int LS_CALLTYPE LSgetStageName(pLSmodel pModel,
                             int      nIndex,
                             char     *pachName);


int LS_CALLTYPE LSgetStocInfo(pLSmodel  pModel,
                            int       nQuery,
                            int       nParam,
                            void      *pvResult);

int LS_CALLTYPE LSgetStocCCPInfo(pLSmodel  pModel,
                            int       nQuery,
                            int       nScenarioIndex,
                            int       nCPPIndex,
                            void      *pvResult);

int LS_CALLTYPE LSloadSampleSizes(pLSmodel  pModel,
                            int     *panSampleSize);

int LS_CALLTYPE LSloadConstraintStages(pLSmodel pModel,
                             int     *panStage);

int LS_CALLTYPE LSloadVariableStages(pLSmodel pModel,
                             int     *panStage);

int LS_CALLTYPE LSloadStageData(pLSmodel pModel,
                             int     numStages,
                             int     *panRstage,
                             int     *panCstage);

int LS_CALLTYPE LSloadStocParData(pLSmodel pModel,
                             int     *panSparStage,
                             double  *padSparValue);

int LS_CALLTYPE LSloadStocParNames(pLSmodel  pModel,
                            int       nSvars,
                            char      **paszSVarNames);

pLSmodel LS_CALLTYPE LSgetDeteqModel(pLSmodel pModel,
                             int     iDeqType,
                             int     *pnErrorCode);

int LS_CALLTYPE LSaggregateStages(pLSmodel  pModel,
                             int     *panScheme,
                             int     nLength);

int LS_CALLTYPE LSgetStageAggScheme(pLSmodel  pModel,
                             int     *panScheme,
                             int     *pnLength);

int LS_CALLTYPE LSdeduceStages(pLSmodel     pModel,
                             int     nMaxStage,
                             int     *panRowStagse,
                             int     *panColStages,
                             int     *panSparStage);
...
int LS_CALLTYPE LSsolveSP(pLSmodel pModel,
                             int     *pnStatus);

int LS_CALLTYPE LSsolveHS(pLSmodel pModel,
                             int     nSearchMethod,
                             int     *pnStatus);

/* solution access routines */
int LS_CALLTYPE LSgetScenarioObjective(pLSmodel pModel,
                             int      jScenario,
                             double   *pObj);

int LS_CALLTYPE LSgetNodePrimalSolution(pLSmodel pModel,
                             int     jScenario,
                             int     iStage,
                             double  *padX);

int LS_CALLTYPE LSgetNodeDualSolution(pLSmodel pModel,
                             int     jScenario,
                             int     iStage,
                             double  *padY);

int LS_CALLTYPE LSgetNodeReducedCost(pLSmodel pModel,
                             int     jScenario,
                             int     iStage,
                             double  *padX);

int LS_CALLTYPE LSgetNodeSlacks(pLSmodel pModel,
                             int     jScenario,
                             int     iStage,
                             double  *padY);

int LS_CALLTYPE LSgetScenarioPrimalSolution(pLSmodel pModel,
                             int      jScenario,
                             double   *padX,
                             double   *pObj);

int LS_CALLTYPE LSgetScenarioReducedCost(pLSmodel pModel,
                             int      jScenario,
                             double   *padD);

int LS_CALLTYPE LSgetScenarioDualSolution(pLSmodel pModel,
                             int     jScenario,
                             double  *padY);

int LS_CALLTYPE LSgetScenarioSlacks(pLSmodel pModel,
                             int      jScenario,
                             double   *padS);

int LS_CALLTYPE LSgetNodeListByScenario(pLSmodel pModel,
                             int     jScenario,
                             int     *paiNodes,
                             int     *pnNodes);

int LS_CALLTYPE LSgetProbabilityByScenario(pLSmodel pModel,
                             int     jScenario,
                             double  *pdProb);

int LS_CALLTYPE LSgetProbabilityByNode(pLSmodel pModel,
                             int     iNode,
                             double  *pdProb);

int LS_CALLTYPE LSgetStocParData(pLSmodel pModel,
                             int     *paiStages,
                             double  *padVals);

/* load stochastic data */
int LS_CALLTYPE LSaddDiscreteBlocks(pLSmodel pModel,
                             int     iStage,
                             int     nRealzBlock,
                             double  *padProb,
                             int     *pakStart,
...
int LS_CALLTYPE LSaddScenario(pLSmodel pModel,
                             int      jScenario,
                             int      iParentScen,
                             int      iStage,
                             double   dProb,
...
int LS_CALLTYPE LSaddDiscreteIndep(pLSmodel pModel,
                             int      iRow,
                             int      jCol,
                             int      iStv,
                             int      nRealizations,
...
int LS_CALLTYPE LSaddParamDistIndep(pLSmodel pModel,
                             int      iRow,
                             int      jCol,
                             int      iStv,
                             int      nDistType,
...
int LS_CALLTYPE LSaddUserDist(pLSmodel pModel,
                             int      iRow,
                             int      jCol,
                             int      iStv,
                             UserPdf_t  pfUserFunc,
                             int      nSamples,
                             pLSsample *paSamples,
                             void     *pvUserData,
                             int      iModifyRule);

int LS_CALLTYPE LSaddChanceConstraint(pLSmodel pModel,
                             int      iSense,
                             int      nCons,
                             int      *paiCons,
                             double   dPrLevel,
...
int LS_CALLTYPE LSsetNumStages(pLSmodel pModel,
                             int     numStages);

int LS_CALLTYPE LSgetStocParOutcomes(pLSmodel pModel,
                             int      jScenario,
                             double   *padVals,
                             double   *padProbs);

int LS_CALLTYPE LSloadCorrelationMatrix(pLSmodel pModel,
                             int     nDim,
                             int     nCorrType,
                             int     nQCnnz,
                             int     *paiQCcols1,
...
int LS_CALLTYPE LSgetCorrelationMatrix(pLSmodel pModel,
                             int     iFlag,
                             int     nCorrType,
                             int     *pnQCnnz,
                             int     *paiQCcols1,
...
pLSsample LS_CALLTYPE LSgetStocParSample(pLSmodel pModel,
                             int      iStv,
                             int      iRow,
                             int      jCol,
                             int      *pnErrorCode);

int LS_CALLTYPE LSgetDiscreteBlocks(pLSmodel pModel,
                             int     iEvent,
                             int     *nDistType,
                             int     *iStage,
                             int     *nRealzBlock,
...
int LS_CALLTYPE LSgetDiscreteBlockOutcomes(pLSmodel pModel,
                             int     iEvent,
                             int     iRealz,
                             int     *nRealz,
                             int     *paiArows,
...
int LS_CALLTYPE LSgetDiscreteIndep(pLSmodel pModel,
                             int     iEvent,
                             int     *nDistType,
                             int     *iStage,
                             int     *iRow,
...
int LS_CALLTYPE LSgetParamDistIndep(pLSmodel pModel,
                             int     iEvent,
                             int     *nDistType,
                             int     *iStage,
                             int     *iRow,
...
int LS_CALLTYPE LSgetScenario(pLSmodel pModel,
                             int     jScenario,
                             int     *iParentScen,
                             int     *iBranchStage,
                             double  *pdProb,
...
int LS_CALLTYPE LSgetChanceConstraint(pLSmodel pModel,
                             int     iChance,
                             int     *piSense,
                             int     *pnCons,
                             int     *paiCons,
...
int LS_CALLTYPE LSgetSampleSizes(pLSmodel  pModel,
                             int     *panSampleSize);

int LS_CALLTYPE LSgetConstraintStages(pLSmodel pModel,
                             int     *panStage);

int LS_CALLTYPE LSgetVariableStages(pLSmodel pModel,
                             int     *panStage);

int LS_CALLTYPE LSgetStocRowIndices(pLSmodel pModel,
                           int      *paiSrows);

int LS_CALLTYPE LSsetStocParRG(pLSmodel pModel,
                             int      iStv,
                             int      iRow,
                             int      jCol,
                             pLSrandGen pRG);

pLSmodel LS_CALLTYPE LSgetScenarioModel(pLSmodel pModel,
                            int       jScenario,
                            int       *pnErrorcode);

/* memory routines */
void LS_CALLTYPE LSfreeStocMemory(pLSmodel pModel);

void LS_CALLTYPE LSfreeStocHashMemory(pLSmodel pModel);

/* stochastic parameter routines */
int LS_CALLTYPE LSgetModelStocParameter(pLSmodel  pModel,
                            int       nQuery,
                            void      *pvResult);

int LS_CALLTYPE LSsetModelStocParameter(pLSmodel  pModel,
                            int       nQuery,
                            void      *pvResult);

 int LS_CALLTYPE LSsetEnvStocParameter(pLSenv pEnv,
                             int     nParameter,
                             void    *pvValue);

 int LS_CALLTYPE LSgetEnvStocParameter(pLSenv pEnv,
                             int     nParameter,
                             void    *pvValue);
 ...
 *********************************************************************/
/* Public Functions */
pLSsample LS_CALLTYPE LSsampCreate(pLSenv pEnv,
                            int       nDistType,
                            int       *pnErrorCode);

int LS_CALLTYPE LSsampDelete(pLSsample *pSample);

int LS_CALLTYPE LSsampSetUserDistr(pLSsample pSample,
                             UserPdf_t  pfUserFunc,
                             void       *pvUserData);

int LS_CALLTYPE LSsampSetDistrParam(pLSsample pSample,
                             int      nIndex,
                             double   dValue);

int LS_CALLTYPE LSsampGetDistrParam(pLSsample pSample,
                             int      nIndex,
                             double   *pdValue);

int LS_CALLTYPE LSsampEvalDistr(pLSsample pSample,
                             int      nFuncType,
                             double   dXval,
                             double   *pdResult);

int LS_CALLTYPE LSsampEvalDistrLI(pLSsample pSample,
                             int      nFuncType,
                             double   dXval,
                             double   *pdResult);

int LS_CALLTYPE LSsampEvalUserDistr(pLSsample pSample,
                             int      nFuncType,
                             double   *padXval,
                             int      nDim,
                             double   *pdResult);

int LS_CALLTYPE LSsampSetRG(pLSsample pSample,
                             void     *pRG);

int LS_CALLTYPE LSsampGenerate(pLSsample pSample,
                             int      nMethod,
                             int      nSize);

int LS_CALLTYPE LSsampGetPointsPtr(pLSsample pSample,
                             int      *pnSampSize,
                             double   **pdXval);

int LS_CALLTYPE LSsampGetPoints(pLSsample pSample,
                             int      *pnSampSize,
                             double   *pdXval);

int LS_CALLTYPE LSsampLoadPoints(pLSsample pSample,
                             int      nSampSize,
                             double   *pdXval);

int LS_CALLTYPE LSsampGetCIPointsPtr(pLSsample pSample,
                             int      *pnSampSize,
                             double   **pdXval);

int LS_CALLTYPE LSsampGetCIPoints(pLSsample pSample,
                             int      *pnSampSize,
                             double   *pdXval);

int LS_CALLTYPE LSsampInduceCorrelation(pLSsample *paSample,
                             int      nDim,
                             int      nCorrType,
                             int      nQCnonzeros,
                             int      *paiQCvarndx1,
...
int LS_CALLTYPE LSsampGetCorrelationMatrix(pLSsample *paSample,
                             int      nDim,
                             int      iFlag,
                             int      nCorrType,
                             int      *nQCnonzeros,
...
int LS_CALLTYPE LSsampLoadDiscretePdfTable(pLSsample pSample,
                             int      nLen,
                             double   *padProb,
                             double   *padVals);

int LS_CALLTYPE LSsampGetDiscretePdfTable(pLSsample pSample,
                             int      *pnLen,
                             double   *padProb,
                             double   *padVals);

int LS_CALLTYPE LSsampGetInfo(pLSsample  pSample,
                             int      nQuery,
                             void     *pvResult);

int LS_CALLTYPE LSsampAddUserFuncArg(pLSsample pSample,
                             pLSsample pSampleSource);


int LS_CALLTYPE LSregress(int nNdim,
                          int nPdim,
                          double *padU,
                          double *padX,
                          double *padB,
 ...
 *********************************************************************/
/* Public functions */
pLSrandGen LS_CALLTYPE LScreateRG(pLSenv pEnv,
                             int      nMethod);

pLSrandGen LS_CALLTYPE LScreateRGMT(pLSenv pEnv,
                             int      nMethod);

double LS_CALLTYPE LSgetDoubleRV(pLSrandGen pRG);

int  LS_CALLTYPE LSgetInt32RV(pLSrandGen pRG,
                             int      iLow,
                             int      iHigh);

void LS_CALLTYPE LSsetRGSeed(pLSrandGen pRG,
                             int      nSeed);

void LS_CALLTYPE LSdisposeRG(pLSrandGen *ppRG);

int LS_CALLTYPE LSsetDistrParamRG(pLSrandGen pRG,
                             int      iParam,
                             double   dParam);

int LS_CALLTYPE LSsetDistrRG(pLSrandGen pRG,
                             int      nDistType);

int LS_CALLTYPE LSgetDistrRV(pLSrandGen pRG,
                             void     *pvResult);

int LS_CALLTYPE LSgetInitSeed(pLSrandGen pRG);

int LS_CALLTYPE LSgetRGNumThreads(pLSrandGen pRG,
                             int      *pnThreads);

int LS_CALLTYPE LSfillRGBuffer(pLSrandGen pRG);

double* LS_CALLTYPE LSgetRGBufferPtr(pLSrandGen pRG,
                             int      *pnBufferLen);

/* Reserved functions */
int LS_CALLTYPE LSgetJavaHandle(void  *pvOwner,
                             int    iCastType,
                             int    iObject,
                             void  *pvjObject);

 int LS_CALLTYPE LSsetJavaHandle(void *pvOwner,
                             int    iCastType,
                             int    iObject,
                             void  *pvjObject);

 void* LS_CALLTYPE LSgetObjHandle(void  *pvOwner,
                             int    iCastType,
                             int    iObject);
/* Auxiliary functions */

int LS_CALLTYPE LSgetHistogram(pLSmodel pModel,
                            int      nSampSize,
                            double   *padVals,
                            double   *padWeights,
                            double   dHistLow,
                            ...
                            double   *padBinLow,
                            double   *padBinHigh,
                            double   *padBinLeftEdge,
                            double   *padBinRightEdge);

int LS_CALLTYPE LSsampGetCorrDiff(pLSmodel pModel,
                            pLSsample *paSample,
                            int       nDim,
                            int       nDiffType,
                            double    *pdNorm1,
...
int LS_CALLTYPE LSgetNnzData(pLSmodel pModel,
                             int      mStat,
                             int      *panOutput);
...
int LS_CALLTYPE LSsolveFileLP(pLSmodel    pModel,
                           char        *szFileNameMPS,
                           char        *szFileNameSol,
...
int LS_CALLTYPE LSreadSolutionFileLP(  char        *szFileNameSol,
                                    int         nFileFormat,
                                    long long   nBeginIndexPrimalSol,
                                    long long   nEndIndexPrimalSol,
                                    int         *pnSolStatus,
                                    double      *pdObjValue,
                                    int         *pnNoOfCons,
                                    long long   *plNoOfCols,
                                    int         *pnNoOfColsEvaluated,
                                    int         *pnNoOfIterations,
                                    double      *pdTimeTakenInSeconds,
                                    double      *padPrimalValues,
                                    double      *padDualValues);
...
int LS_CALLTYPE LSdateDiffSecs(int nYr1,
                            int      nMon1,
                            int      nDay1,
                            int      nHr1,
                            int      nMin1,
...
int LS_CALLTYPE LSdateYmdhms(double dSecdiff,
                            int      nYr1,
                            int      nMon1,
                            int      nDay1,
                            int      nHr1,
...
int LS_CALLTYPE LSdateToday(int      *pnYr1,
                            int      *pnMon1,
                            int      *pnDay1,
                            int      *pnHr1,
                            int      *pnMin1,
...
int LS_CALLTYPE LSdateMakeDate(int nYYYY, int nMM, int nDD);
double LS_CALLTYPE LSdateMakeTime(int nHH, int nMM, double dSS);
void LS_CALLTYPE LSdateSetBaseDate(int nYYYY, int nMM, int nDD);
double LS_CALLTYPE LSdateScalarSec(int nDate, double dTime);
void LS_CALLTYPE LSdateScalarSecInverse(double dSSEC, int *pnDate, double *pdTime);
double LS_CALLTYPE LSdateScalarHour(int nDate, double dTime);
void LS_CALLTYPE LSdateScalarHourInverse(double dSHOUR, int *pnDate, double *pdTime);
double LS_CALLTYPE LSdateJulianSec(int nDate, double dTime);
void LS_CALLTYPE LSdateJulianSecInverse(double dJSEC, int *pnDate, double *pdTime);
double LS_CALLTYPE LSdateJulianHour(int nDate, double dTime);
void LS_CALLTYPE LSdateJulianHourInverse(double dJHOUR, int *pnDate, double *pdTime);
void LS_CALLTYPE LSdateDiff(int nDate1, double dTime1, int nDate2, double dTime2, int *pnDays, double *pdSecs);
void LS_CALLTYPE LSdateNow(int *pnDate, double *pdTime);
int LS_CALLTYPE LSdateIsLeapYear(int nYear);
int LS_CALLTYPE LSdateJulianDay(int nDate);
int LS_CALLTYPE LSdateDayOfWeek(int nDate);
int LS_CALLTYPE LSdateWeekOfYear(int nDate);
int LS_CALLTYPE LSdateQuarterOfYear(int nDate);
int LS_CALLTYPE LSdateDayOfYear(int nDate);
int LS_CALLTYPE LSdateNextWeekDay(int nDate);
int LS_CALLTYPE LSdatePrevWeekDay(int nDate);
int LS_CALLTYPE LSdateNextMonth(int nDate);
int LS_CALLTYPE LSdateDateToDays(int nDate);
int LS_CALLTYPE LSdateDaysToDate(int nDays);
double LS_CALLTYPE LSdateTimeToSecs(double dTime);
double LS_CALLTYPE LSdateSecsToTime(double dSecs);
void LS_CALLTYPE LSdateFutureDate(int *pnDate, double *pdTime, int nDays, int dSecs);
void LS_CALLTYPE LSdatePastDate(int *pnDate, double *pdTime, int nDays, double dSecs);
int LS_CALLTYPE LSdateIsValidDate(int nDate);
int LS_CALLTYPE LSdateIsValidTime(double dTime);
int LS_CALLTYPE LSdateIsDateFuture(int nDate, double dTime);
int LS_CALLTYPE LSdateIsDatePast(int nDate, double dTime);
int LS_CALLTYPE LSdateYear(int nDate);
int LS_CALLTYPE LSdateMonth(int nDate);
int LS_CALLTYPE LSdateDay(int nDate);
int LS_CALLTYPE LSdateHour(double dTime);
int LS_CALLTYPE LSdateMinute(double dTime);
double LS_CALLTYPE LSdateSecond(double dTime);
int LS_CALLTYPE LSdateWeekOfMonth(int nDate);
char* LS_CALLTYPE LSdateLocalTimeStamp(char *szTimeBuffer);
int LS_CALLTYPE LSdateDateNum(int nDate);
int LS_CALLTYPE LSdateMakeDateNum(int nYYYY, int nMM, int nDD);
...
int         LS_CALLTYPE LSrunTuner(pLSenv pEnv);
int         LS_CALLTYPE LSrunTunerFile(pLSenv pEnv,
                             char      *szJsonFile);
int         LS_CALLTYPE LSrunTunerString(pLSenv pEnv,
                             char      *szJsonString);
int         LS_CALLTYPE LSloadTunerConfigString(pLSenv pEnv,
                             char      *szJsonString);
int         LS_CALLTYPE LSloadTunerConfigFile(pLSenv pEnv,
                             char      *szJsonFile);
int         LS_CALLTYPE LSclearTuner(pLSenv pEnv);
int         LS_CALLTYPE LSresetTuner(pLSenv pEnv);
int         LS_CALLTYPE LSprintTuner(pLSenv pEnv);
int         LS_CALLTYPE LSsetTunerOption(pLSenv pEnv,
                             char      *szKey,
                             double    dval);
int         LS_CALLTYPE LSgetTunerOption(pLSenv pEnv,
                             char      *szkey,
                             double    *pdval);
int         LS_CALLTYPE LSsetTunerStrOption(pLSenv pEnv,
                                         char      *szKey,
                                         char      *szval);
int         LS_CALLTYPE LSgetTunerStrOption(pLSenv pEnv,
                                         char      *szkey,
                                         char      *szval);
int         LS_CALLTYPE LSgetTunerResult(pLSenv pEnv,
                             char      *szkey,
                             int       jInstance,
                             int       kConfig,
                             double    *pdval);
int         LS_CALLTYPE LSgetTunerSpace(pLSenv pEnv,
                             int       *panParamId,
                             int       *numParam);
int         LS_CALLTYPE LSwriteTunerConfigString(pLSenv pEnv,
                             char      *szJsonString,
                             char      *szJsonFile);
int         LS_CALLTYPE LSgetTunerConfigString(pLSenv pEnv,
                             char      **pszJsonString);
int         LS_CALLTYPE LSwriteTunerParameters(pLSenv pEnv,
                             char      *szFile,
                             int       jInstance,
                             int       mCriterion);

int         LS_CALLTYPE LSaddTunerInstance(pLSenv pEnv,
                             char      *szFile);

int         LS_CALLTYPE LSaddTunerModelInstance(pLSenv pEnv,
                                           char      *szKey,
                                           pLSmodel pModel);
int         LS_CALLTYPE LSaddTunerZStatic(pLSenv pEnv,
                             int       jGroupId,
                             int       iParam,
                             double    dValue);
int         LS_CALLTYPE LSaddTunerZDynamic(pLSenv pEnv,
                             int       iParam);
int         LS_CALLTYPE LSaddTunerOption(pLSenv pEnv,
                             char      *szKey,
                             double    dValue);
int         LS_CALLTYPE LSaddTunerStrOption(pLSenv pEnv,
                             char      *szKey,
                             char      *szValue);
int         LS_CALLTYPE LSdisplayTunerResults(pLSenv pEnv);
 ...
 **********************************************************************/
 ...
 int LS_CALLTYPE LSgetLicenseInfo(pLSmodel pModel,
                             int     *pnMaxcons,
                             int     *pnMaxvars,
                             int     *pnMaxintvars,
                             int     *pnReserved1,
 ...
 /* Deprecated,  use LSgetInfo() */
 int LS_CALLTYPE LSgetDimensions(pLSmodel pModel,
                             int     *pnVars,
                             int     *pnCons,
                             int     *pnCones,
                             int     *pnAnnz,
 ...
 int LS_CALLTYPE LSbnbSolve(pLSmodel  pModel,
                             char    *pszFname);

 /* Deprecated,  use LSgetInfo() */
 int LS_CALLTYPE LSgetDualMIPsolution(pLSmodel pModel,
                             double  *padPrimal,
                             double  *padDual,
                             double  *padRedcosts,
                             int     *panCstatus,
...
/* Deprecated,  use LSgetInfo() */
 int LS_CALLTYPE LSgetMIPSolutionStatus(pLSmodel  pModel,
                             int     *pnStatus);

/* Deprecated,  use LSgetInfo() */
 int LS_CALLTYPE LSgetSolutionStatus(pLSmodel  pModel,
                                 int     *nStatus);

/* Deprecated,  use LSgetInfo() */
 int LS_CALLTYPE LSgetObjective(pLSmodel pModel,
                             double  *pdObjval);

/* Deprecated,  use LSgetInfo() */
 int LS_CALLTYPE LSgetSolutionInfo(pLSmodel pModel,
                             int     *pnMethod,
                             int     *pnElapsed,
                             int     *pnSpxiter,
                             int     *pnBariter,
...
/* Deprecated,  use LSgetInfo() */
 int LS_CALLTYPE LSgetMIPSolution(pLSmodel  pModel,
                             double  *pdPobjval,
                             double  *padPrimal);

/* Deprecated,  use LSgetInfo() */
 int LS_CALLTYPE LSgetCurrentMIPSolutionInfo(pLSmodel pModel,
                             int     *pnMIPstatus,
                             double  *pdMIPobjval,
                             double  *pdBestbound,
                             double  *pdSpxiter,
...
/* Command Line Parser */
int LS_CALLTYPE LSgetCLOpt(pLSenv pEnv,
                                     int       nArgc,
                                     char      **pszArgv,
                                     char      *pszOpt);

int LS_CALLTYPE LSgetCLOptArg(pLSenv pEnv,
                                     char      **pszOptArg);

int LS_CALLTYPE LSgetCLOptInd(pLSenv pEnv,
                                     int       *pnOptInd);

int LS_CALLTYPE LSsolveExternally(pLSmodel pModel,
                                  int      mSolver,
                                  int      nMethod,
                                  int      nFileFormat,
                                  int      *pnStatus);

pLSmodel LS_CALLTYPE LSgetMasterModel(pLSmodel  pModel);
